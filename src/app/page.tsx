...
import {
  ...
  Image as ImageIcon, ListChecks, LogOut, Shield, Edit, BarChartHorizontalBig, FileUp, Download, Wand2, CheckCircle, UserPlus, Search
} from 'lucide-react';
...
import { deleteReportAction, getReportsAction, batchUpdateStudentScoresAction, getAiReportInsightsAction, getBulkAiTeacherFeedbackAction, editImageWithAiAction } from '@/app/actions';
                ...
                <CardContent className="p-2 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                    ...
                    <div className="space-y-1">
                      ...
                      <Input id="sessionInstructorContact" value={(sessionDefaults as any).instructorContact ?? ''} onChange={e => handleSessionDefaultChange('instructorContact', e.target.value)} placeholder="Phone or Email" />
                    </div>
