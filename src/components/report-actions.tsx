...
import { Mail, MessageSquare, User, Edit, Trash2 } from 'lucide-react'; // Using MessageSquare for WhatsApp-like icon
...
export default function ReportActions({ report, onEditReport, onDeleteReport }: ReportActionsProps) {
