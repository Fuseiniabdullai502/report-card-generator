...
2. **Strengths**: CRITICAL - ALWAYS identify at least one subject or trend where the class is performing well. Be encouraging. Do not leave this field empty.
...
5. **Recommended Resources**: CRITICAL - Based on the 'Areas for Concern', recommend 2-3 specific, high-quality, and well-known educational websites or YouTube channels (like Khan Academy, BBC Bitesize, CrashCourse, etc.) that could help the teacher and students. For each resource, provide its name, type (Website or YouTube Channel), a valid URL, and a brief description of its relevance.
